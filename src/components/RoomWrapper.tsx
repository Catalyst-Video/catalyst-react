  ...
  return (
    <>
      {!speakerMode && (
        ...
        >
          ...
          {members.length === 1 && (
            ...
            >
              <div className="absolute not-selectable top-0 left-1 w-full h-full flex justify-center items-center z-0 text-c text-white dark:text-black">
                <span>👋 Waiting for others to join...</span>
              </div>
            </div>
          )}
      ...
      {/* {speakerMode && (
        ...
        >
          <div className="speaker-vid p-1 flex flex-col justify-center">
            {members.map((m, i) => {
              if (m.sid === mainVid) {
                return (
                  <MemberView
                ...
                if (s.sid !== mainVid)
                  return (
                    <ScreenShareWrapper
                      ...
                      width={'100%'}
                      classes={
                        'box ml-1 mr-1 sm:mt-1 sm:mb-1 sm:ml-0 sm:mr-0 w-full aspect-w-16 aspect-h-9'
                      }
