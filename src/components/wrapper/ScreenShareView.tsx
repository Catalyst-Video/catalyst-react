           ...
           <div className={classes} onClick={onClick}>
             ...
             >
               ...
               <div className="absolute bottom-0 left-0 flex text-white justify-between p-2 w-full">
                 <div className="text-white text-sm not-selectable flex items-center justify-center bg-background bg-opacity-40 px-2 py-1 rounded-xl">
                   {'Sharing'}
                 </div>
                 <div>
                   <FontAwesomeIcon
                     icon={faDesktop}
                     size="2x"
                     className={`text-white not-selectable bg-background h-10 w-10 bg-opacity-40 p-2 rounded-full`}
                   />
                 </div>
               </div>
             </div>
