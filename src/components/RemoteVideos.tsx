  ...
  ({
    ...
    const resizeWrapper = () => {
      ...
      while (i < 5000) {
        let w = area(
          i,
          // TODO: switch localstream here to prop determining whether to show local video as large or small
    ...
    return (
      ...
      >
        ...
        {/* // TODO: switch localstream here to prop determining whether to show
        local video as large or small */}
