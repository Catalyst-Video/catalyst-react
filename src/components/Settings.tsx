              ...
              {!hidden?.darkmode ? (
                <div className="w-full text-center mb-4 px-4 sm:px-0 ">
                  <button
                    ...
                    type="button"
                    className={`w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-${themeColor} text-base font-medium text-white hover:bg-${themeColor} focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-gray-400 focus:ring-${themeColor} sm:ml-3 sm:w-auto sm:text-sm`}
                  >
                    <FontAwesomeIcon
